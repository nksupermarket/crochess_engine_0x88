...
public class Psqt {
  ...
  private static final long[][][] PieceBonus = {
    ...
    {},
    { // Knight
      {S(-175, -175, -96), S(-92, -92, -65), S(-74, -74, -49), S(-73, -73, -21)},
      {S(-77, -77, -67), S(-41, -41, -54), S(-27, -27, -18), S(-15, -15, 8)},
    ...
    { // Bishop
      ...
      {S(-11, -11, -26), S(6, 6, -9), S(13, 13, -12), S(3, 3, 1)},
      {S(-5, -5, -11), S(15, 15, -1), S(-4, -4, -1), S(-3, 12, 7)},
      {S(-4, -4, -14), S(8, 8, -4), S(18, 18, 0), S(27, 27, 12)},
