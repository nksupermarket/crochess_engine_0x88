...
//                Arrays.fill(board,
//                        0);
//                List<Integer> queenMoves = MoveGen.pseudoLegal(board,
//                        Square.lookup.get(j),
//                        Piece.QUEEN,
//                        Color.W);
//                List<Integer> bishopMoves = MoveGen.pseudoLegal(board,
//                        Square.lookup.get(j),
//                        Piece.BISHOP,
//                        Color.W);
//                List<Integer> rookMoves = MoveGen.pseudoLegal(board,
//                        Square.lookup.get(j),
//                        Piece.ROOK,
//                        Color.W);
//                List<Integer> knightMoves = MoveGen.pseudoLegal(board,
//                        Square.lookup.get(j),
//                        Piece.KNIGHT,
//                        Color.W);
//                List<Integer> kingMoves = MoveGen.pseudoLegalForKing(board,
//                        Square.lookup.get(j),
//                        Color.W,
//                        castleRights,
//                        bPieceList);
...
//                List<Integer> wPawnMoves = MoveGen.pseudoLegalForPawn(board,
//                        Square.lookup.get(j),
//                        Color.W,
//                        enPassant);
//                Arrays.fill(board,
//                        Color.W.id | Piece.PAWN.id);
//                List<Integer> bPawnMoves = MoveGen.pseudoLegalForPawn(board,
//                        Square.lookup.get(j),
//                        Color.B,
//                        enPassant);
//
