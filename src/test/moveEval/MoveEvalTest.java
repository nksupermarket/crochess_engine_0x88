...
public class MoveEvalTest {
    ...
    public void givesSameMoveOnRepeatCalls() {
        ...
        int repeat = MoveEval.getBestMove();
    ...
    class tactics {
        ...
        public void pos1() {
            ...
            int wBestMove = MoveEval.getBestMove();
            ...
            int bBestMove = MoveEval.getBestMove();
    ...
    class engineDebug {
        ...
        public void posDebug() {
            ...
            Utils.printMove(MoveEval.getBestMove());
            Utils.printMove(MoveEval.getBestMove());
        }
